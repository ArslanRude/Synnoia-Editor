  ...
  <nav>
    <div class="bg-secondary-light dark:bg-secondary-dark px-3 sm:px-5 py-2 flex items-center justify-between">
      ...
      <div class="hidden md:flex items-center space-x-2 flex-shrink-0">
        ...
        <div class="p-2 hover:bg-highlight-light dark:hover:bg-highlight-dark rounded-lg transition-colors duration-200 text-black dark:text-gray-200 min-w-[44px] min-h-[44px] flex items-center justify-center">
          <UserMenu />
        </div>
      </div>
