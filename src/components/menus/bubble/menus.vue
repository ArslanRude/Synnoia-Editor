<template>
  ...
  <template v-else>
    ...
    <div
      ...
      "
      class="arslan-bubble-menu-divider"
    ></div>
...
<style lang="less">
.arslan-bubble-menu-divider {
  width: 1px;
  border-right: solid 1px var(--arslan-border-color-light);
  height: 16px;
  margin: 0 10px 0 5px;
  &:last-child:is(.arslan-bubble-menu-divider) {
    display: none;
  }
}
</style>
